...
export default class MapOfSet extends ExtMap {
     ...
     */
    constructor(iterable: Iterable<any>, fn?: Function | undefined);
    /**
     ...
     */
    add(iterable: Iterable<any>, fn?: Function | undefined): MapOfSet;
    /**
     ...
     * @return {MapOfSet} this
     */
    addWithChildren(iterable: Iterable<any>, mainFn?: Function | undefined, childrenFn?: Function | undefined): MapOfSet;
    /**
     ...
     */
    getSortedArray(keySortFn?: Function | undefined, childSortFn?: Function | undefined): array;
    get sortedArray(): array;
}
import ExtMap from "../extensions/ExtMap";
import ExtSet from "../extensions/ExtSet";
//# sourceMappingURL=MapOfSet.d.ts.map