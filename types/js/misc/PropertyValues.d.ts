...
declare class PropertyValues extends Set<any> {
     ...
     */
    addValues(data: object | Iterable<object>, keyName: any, radical?: string | undefined): this;
    /**
     ...
     */
    addChildren(data: object | Iterable<any>, childrenItrKey: string, keyName: string, radicalKeyName?: string | undefined): this;
    /**
     ...
     * @returns {Array}
     */
    sortedArray(fn?: Function | undefined): any[];
    /**
