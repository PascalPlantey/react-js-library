 ...
 * @param {React.RefObject|string|Element} selector Element to be looked for; can be a string (tag ID or selector), or a ref (useRef), or an event target
 ...
 * @memberof Hooks#
 */
declare function useResizeObserver(selector: import("react").RefObject<any> | string | Element, step?: number | undefined, box?: string | undefined): object;
