...
const Graph = () => (
  <svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
    <g>
      <path d="M59,56h-2V33H45v23h-1V42H32v14h-1V11H19v45h-1V19H6v37H4V1c0-0.553-0.447-1-1-1S2,0.447,2,1v55H1c-0.553,0-1,0.447-1,1
        s0.447,1,1,1h1v1c0,0.553,0.447,1,1,1s1-0.447,1-1v-1h2h12h1h12h1h12h1h12h2c0.553,0,1-0.447,1-1S59.553,56,59,56z M8,56V21h8v35H8
        z M26,56c0-0.552-0.448-1-1-1s-1,0.448-1,1h-3v-3v-6v-6v-6v-6v-6v-6v-4h4h4v4v6v6v6v6v6v6v3H26z M34,56V44h8v12H34z M47,56V35h8v21
        H47z"
      />
